...
if !exists("b:qrexec_syntax_policyservice") || empty(b:qrexec_syntax_policyservice)
...
elseif exists("b:qrexec_syntax_policyservice") && !empty(b:qrexec_syntax_policyservice)
