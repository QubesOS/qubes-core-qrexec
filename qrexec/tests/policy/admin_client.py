...
class Client(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.make_command_fail_patch = unittest.mock.patch(
            "qrexec.client.make_command",
            side_effect=self.make_command_fail_side_effect,
        )
    ...
    def tearDown(self):
        ...
        self.make_command_fail_patch.stop()
    ...
    def test_api_remove(self):
        ...
        (self.policy_dir / "include/inc").touch()
        self.client.policy_include_remove(name="inc", token="any")
        assert not (self.policy_dir / "include/inc").exists()
    ...
    def test_api_failure(self):
        self.make_command_patch.stop()
        self.make_command_fail_patch.start()
        with pytest.raises(
            subprocess.CalledProcessError, match="returned non-zero exit"
        ):
