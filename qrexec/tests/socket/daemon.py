...
""",
    ...
    def assertExpectedStdout(self, target, expected_stdout: bytes, exit_code: int=0):
        ...
        while bytes_recvd < expected:
            ...
            self.assertEqual(msg_body, expected_stdout[bytes_recvd:new_bytes_received])
...
""",
        ...
        self.assertExpectedStdout(source,
    ...
    def _test_run_dom0_service_failed(self,
                                      exit_status=qrexec.QREXEC_EXIT_PROBLEM,
                                      cmd = ""):
        if cmd:
