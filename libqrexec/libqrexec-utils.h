 ...
 * "QREXEC_SERVICE_PATH", which is inherited.  If *program* is not NULL and *cmd* does
 * not start with "QUBESRPC ", or if *program* is NULL and *cmd* starts with "QUBESRPC",
 * fails an assertion.  If *program* is NULL and *cmd* does not start with "QUBESRPC",
